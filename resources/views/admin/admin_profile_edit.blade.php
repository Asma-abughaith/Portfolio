                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder="Name" name="name" value="{{ $editData->name }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" name="profile_image" id="image" value="{{$editData->username}}" >
                                </div>
                            </div>
                            <div class="row mb-3">
