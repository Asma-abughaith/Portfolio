                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="index.html" class="auth-logo">
                                <img src="<?php echo e(asset('backend/assets/images/logo-dark.png')); ?>" height="30"
                                    class="logo-dark mx-auto" alt="">
                                <img src="<?php echo e(asset('backend/assets/images/logo-light.png')); ?>" height="30"
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>" class="form-horizontal mt-3">
                            ...
                            <div class="form-group mb-0 row mt-2">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a href="<?php echo e(route('password.request')); ?>" class="text-muted"><i class="mdi mdi-lock"></i> Forgot
                                        your password?</a></a>
                                    <?php endif; ?>
                                </div>
                                <div class="col-sm-5 mt-3">
                                    <a href="<?php echo e(route('register')); ?>" class="text-muted"><i
