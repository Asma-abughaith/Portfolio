        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <form method="POST" action="<?php echo e(route('register')); ?>" class="form-horizontal mt-3">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" type="password" required="" id='password' name="password_confirmation" placeholder="password confirmation">
                                </div>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\project1\basic\resources\views/auth/register.blade.php ENDPATH**/ ?>