                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel"
                                ...
                                <p class="desc"><?php echo $aboutpage->long_description; ?></p>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="about__education__item">
                                                <h3 class="title">Al Balqa Applied University</h3>
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__education__item">
                                                <h3 class="title">University of Jordan</h3>
                                                <span class="date">2018 – 2021</span>
                                                <p>-M.SC. Mechanical Engineering – Renewable Energy</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="about__education__item">
                                                <h3 class="title">Al-Hussain Technical University</h3>
                                                <span class="date">2022 – 2023</span>
                                                <p>Upskilling Program, The program covers PHP full stack development,
                                                    presentation
                                                    skills, reporting, communication, time management, work ethics,
                                                    teamwork, leadership, and management skills.</p>
                                            </div>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.main_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project1\basic\resources\views/frontend/about_page.blade.php ENDPATH**/ ?>